var ServiceLocator = (function(_super){
    ...
    function ServiceLocator(logger,utils){
    ...
    var openSocket = function(){
        ...
        try{
            ...
            socket.addEventListener("open",function(e){
                self.logger.log('Socket status: '+socket.readyState + '(opened)',"log");
                dequeueRequest();
            });
            ...
            socket.addEventListener("close",function(){
                self.logger.log('Socket status: '+socket.readyState+' (Closed)',"warning");
            ...
            self.logger.log(exception,"error");
